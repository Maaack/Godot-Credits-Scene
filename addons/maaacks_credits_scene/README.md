...
*Maaack's Credits Scene* is available in both the *Godot Asset Library* and the *Godot Asset Store*. It is available as a plugin, meaning it can be added to an existing project. 
...
[Updating Credits](/addons/maaacks_credits_scene/docs/UpdatingCredits.md)  
